   ...
   public static boolean shouldCollide(Entity source, Entity target) {
      if (source instanceof AbstractMinecartEntityAccessor) {
         ...
         do {
            ...
            ++i;
         } while(check != null && i < ((LinkartConfiguration)LinkartConfigurations.INSTANCE.getConfig()).getCollisionDepth());
         ...
         while(check != target) {
            ...
            ++i;
            if (check == null || i >= ((LinkartConfiguration)LinkartConfigurations.INSTANCE.getConfig()).getCollisionDepth()) {
               return true;
            }
         }
